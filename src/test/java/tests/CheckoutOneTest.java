...
public class CheckoutOneTest extends CommonConditions{
    ...
    @Test(description = "Go back to cart with cancel button")
    ...
    @Test(description = "Continue to checkout 2 without inserting info")
    ...
    @Test(description = "Continue to checkout 2")
